...
class Recipe(cook_title: String, recipe : Array<String>, tag : Array<String>, pics : Array<String>, writer : String, ings: Array<Pair<String,String>>, like_num: Array<Int>, scrap_num : Int){
    /*구조를 만들어 주세요~!*/
    ...
    constructor(cook_title:String,recipe:Array<String>,tag:Array<String>,pics:Array<String>,writer:String,ings: Array<Pair<String,String>>): this(cook_title,recipe,tag, pics, writer, ings, arrayOf<Int>(0,0,0), 0)

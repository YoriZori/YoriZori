...
class Add_Recipe(fragment: Fragment, option :Int = 0) :BackBtnPressListener, Fragment() {
    ...
    override fun onCreateView(
        ...
        view.doneBtn.setOnClickListener {
            ...
            recipe.ings = ings as ArrayList<Pair<String, String>>
            recipe.recipe = recipes as ArrayList<String>
            recipe.tag = arrayListOf(view.tagInput.text.toString())
            recipe.ings =
                arrayListOf(Pair(view.ingInput.text.toString(), view.ingNumInput.text.toString()))
        ...
        view.ingNumInput.setOnKeyListener { v, keyCode, event ->
            if (keyCode == KeyEvent.KEYCODE_ENTER && event.action == KeyEvent.ACTION_UP) {
                ings = append(
                    ings,
                    Pair(view.ingInput.text.toString(), view.ingNumInput.text.toString())
                )
    ...
    fun append(
        arr: Array<Pair<String, String>>,
        element: Pair<String, String>
